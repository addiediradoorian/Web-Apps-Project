...
insert into ENTRIES (ID, City, EatSleepOrSee, EstablishmentName, Stars, Commments) values (2, 'Quito', 'See', 'La Compañía', 4, 'The church is breathtaking');
insert into ENTRIES (ID, City, EatSleepOrSee, EstablishmentName, Stars, Commments) values (3, 'Prague', 'Sleep', 'Pachtuv', 4, 'Always a pleasure to stay at');
insert into ENTRIES (ID, City, EatSleepOrSee, EstablishmentName, Stars, Commments) values (4, 'Rome', 'Eat', 'Mignanelli 24', 1, 'The worst restaurant in Rome');
insert into ENTRIES (ID, City, EatSleepOrSee, EstablishmentName, Stars, Commments) values (5, 'London', 'Eat', 'Sketch', 5, 'Great place!');
insert into ENTRIES (ID, City, EatSleepOrSee, EstablishmentName, Stars, Commments) values (6, 'Copenhagen', 'See', 'Alternative Christiania', 2, 'The Amish of Denmark. Very boring.');
insert into ENTRIES (ID, City, EatSleepOrSee, EstablishmentName, Stars, Commments) values (7, 'Bombay', 'Sleep', 'The Taj Mahal Palace', 5, 'Enchanting and historical');
insert into ENTRIES (ID, City, EatSleepOrSee, EstablishmentName, Stars, Commments) values (8, 'Brussels', 'See', 'Musical Instruments Museum', 3, 'Electronic tour guide did not work');
insert into ENTRIES (ID, City, EatSleepOrSee, EstablishmentName, Stars, Commments) values (9, 'Berlin', 'Sleep', 'Hotel Adlon Kempinski', 4, 'A trip back in time with modern additions');
insert into ENTRIES (ID, City, EatSleepOrSee, EstablishmentName, Stars, Commments) values (10, 'Paris', 'See', 'Eiffel Tower', 2, 'Overrated and disappointing');

Populating the CONTACTUS table:
insert into CONTACTUS (ID, FirstName, LastName, Email, Comments) values (11, ‘Addie’, ‘Diradoorian’, ‘diradoor@bc.edu’, ‘Love this site!’);
insert into CONTACTUS (ID, FirstName, LastName, Email, Comments) values (12, ‘Shukra’, ‘Sabnis’, ‘sabniss@bc.edu’, ‘This site is so easy to use!’);
insert into CONTACTUS (ID, FirstName, LastName, Email, Comments) values (13, ‘Christine’, ‘Kenyon’, ‘kenyonc@bc.edu’, ‘This site is amazing!’);
