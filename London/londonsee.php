...
<![endif]-->
<div class="sign"><a href="http://cscilab.bc.edu/~diradoor/final/newentry/newentry.php">Submit a Review!</div></a>
</head>
...
function show_london_see() {
	...
	WHERE EatSleeporSee='see' AND City='london' ORDER BY EstName ASC";
